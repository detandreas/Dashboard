...
class PortfolioPage(BasePage):
    ...
    def _create_combined_chart_section(self, portfolio: PortfolioSnapshot) -> html.Div:
        """Create combined chart section with dropdown and side metrics."""
        return html.Div([
            # Chart and metrics container
            html.Div([
                # Chart container (left side, wider)
                html.Div([
                    # Chart type selector (left side only - no container)
                    html.Div([
                        dcc.Dropdown(
                            id="chart-selector",
                            options=[
                    ...
                    # Timeframe buttons in top right
                    html.Div([
                        html.Button("1M", id="timeframe-1M", className="timeframe-btn", 
                                   style={"marginRight": "5px"}),
                        html.Button("3M", id="timeframe-3M", className="timeframe-btn", 
                                   style={"marginRight": "5px"}),
                        html.Button("6M", id="timeframe-6M", className="timeframe-btn", 
                                   style={"marginRight": "5px"}),
                        html.Button("1Y", id="timeframe-1Y", className="timeframe-btn", 
                                   style={"marginRight": "5px"}),
                        html.Button("All", id="timeframe-All", className="timeframe-btn active")
                    ], style={
                        "position": "absolute",
                        "top": "10px",
                        "right": "10px",
                    ...
                    # Hidden store for active timeframe
                    dcc.Store(id="active-timeframe", data="All"),
                    
                    html.Div(id="dynamic-chart-container")
                ], style={
                    "flex": "1 1 85%",
                    "maxWidth": "85%",
                    "minWidth": "500px",
                ...
                html.Div([
                    html.Div(id="dynamic-metrics-container")
                ], style={
                    "flex": "1 1 15%",
                    "maxWidth": "15%",
                    "minWidth": "200px",
    ...
    def _create_side_metric_card(self, title: str, value: str, value_color: str, subtitle: str = None) -> html.Div:
